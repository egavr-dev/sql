...
- порядковый номер фильма в порядке увеличения продолжительности (film.length). Нумеруем в рамках групп фильмов с одинаковым значением film.rental_duration.
